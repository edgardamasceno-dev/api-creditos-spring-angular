...
public class Credito {
    ...
    public void setValorIssqn(BigDecimal valorIssqn) {
        if (valorIssqn != null && valorIssqn.compareTo(BigDecimal.ZERO) < 0) {
            throw new IllegalArgumentException("Valor ISSQN não pode ser negativo");
        }
    ...
    public void setAliquota(BigDecimal aliquota) {
        if (aliquota != null && aliquota.compareTo(BigDecimal.ZERO) < 0) {
            throw new IllegalArgumentException("Aliquota não pode ser negativa");
        }
